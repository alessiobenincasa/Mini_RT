...
/*   Updated: 2024/03/27 16:47:20 by svolodin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					add_intersection_plane(t_intersections *xs, double t,
							t_plane *p);
...
t_tuple					local_normal_at_test(t_shape *shape,
							t_tuple local_point);
t_tuple					local_normal_at_plane(t_plane plane,
							t_tuple local_point);
t_plane					plane(void);
